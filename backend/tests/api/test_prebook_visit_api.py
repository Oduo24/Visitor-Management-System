...
def test_create_prebook_visit(
    ...
    payload = {
        ...
        "expected_arrival": "2024-06-01T10:00:00Z",
    }
    ...
    assert body["data"]["visit_type"] == VisitType.PREBOOKED
    assert body["data"]["status"] == VisitStatus.PENDING
    assert body["data"]["visitor_id"] == visitor.id